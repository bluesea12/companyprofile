...
class Init {
	...
	public function template_path( $template_file, $theme_slug, $template_slug ) {
		...
		switch ( $template_slug ) {
			...
			case 'faq':
				return $directory . '/gutenverse-files/templates/faq.html';
			case 'front-page':
			...
			case 'services':
				return $directory . '/gutenverse-files/templates/services.html';
			case 'single':
	...
	public function notice_install_plugin() {
		...
		$button_text = __( 'Install Required Plugins', 'echelon-fse' );
		...
		<div class="notice is-dismissible install-gutenverse-plugin-notice">
			...
			<div class="gutenverse-notice-content">
					...
					<div class="gutenverse-notice-image">
						<img src="<?php echo esc_url( ECHELON_FSE_URI . '/assets/img/banner-install-gutenverse-2.png' ); ?>"/>
					</div>
				</div>
			</div>
		</div>
	...
	public function backend_scripts() {
		...
		if ( $screen->id === 'appearance_page_echelon-fse-dashboard' ) {
			...
			wp_localize_script( 'echelon-fse-dashboard', 'GutenverseThemeConfig', $this->theme_config() );
		}
	}
	...
	public function theme_config() {
		return array(
			'demo'    => esc_url( 'https:/gutenverse.com/demo?name=echelon-fse' ),
			'pages'   => array(
